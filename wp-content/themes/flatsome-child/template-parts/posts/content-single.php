		...
		<div class="entry-author author-box">
			<div class="flex-row align-top">
				...
				<div class="flex-col flex-grow">
					...
					<p class="author-links small">
						<?php $links = ['facebook', 'instagram', 'linkedin', 'pinterest', 'tumblr', 'twitter', 'youtube']; ?>
						<?php foreach($links as $link): ?>
							<?php if (get_the_author_meta( $link )): ?>
								<a class="author-link icon <?php echo $link; ?>" href="<?php echo esc_html( get_the_author_meta( $link ) ); ?>" target="_blank"><i class="icon-<?php echo $link; ?>"></i></a>
							<?php endif; ?>
						<?php endforeach; ?>
					</p>
				</div><!-- .flex-col -->
