...
<?php $single_post = is_singular( 'post' ); ?>

<?php if ( $single_post && get_theme_mod( 'blog_single_header_meta', 1 ) ) : ?>
	<div class="entry-meta uppercase is-xsmall">
		<?php flatsome_posted_on(); ?><span class="reading-time"> | <?php echo ceil(count(explode(' ', get_the_content())) / 200); ?> mins read</span>
	</div><!-- .entry-meta -->
